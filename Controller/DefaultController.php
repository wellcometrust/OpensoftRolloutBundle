...
{
    const ROLLOUT_ROUTE = 'opensoft_rollout';
     ...
     */
    public function __construct(Rollout $rollout, UserProviderInterface $userProvider)
    {
    ...
    public function activateAction($feature)
    {
        ...
        return $this->redirectToRoute(self::ROLLOUT_ROUTE);
    }
